...
const LeadershipCard: React.FC<{ name: string; title: string; }> = ({ name, title }) => (
    <div className="text-center">
        <div className="w-24 h-24 bg-slate-200 dark:bg-dark-panel-hover rounded-full mx-auto mb-2 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-slate-400 dark:text-dark-text-muted" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
            </svg>
        </div>
        <p className="font-bold text-text-primary dark:text-dark-text-primary">{name}</p>
        <p className="text-sm text-text-muted dark:text-dark-text-muted">{title}</p>
    </div>
);
        ...
        <div className="h-full overflow-y-auto pr-4">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                     <div className="inline-block w-20 h-20 bg-[#1E361E] rounded-2xl flex items-center justify-center shadow-lg mb-4">
                    ...
                    <h1 className="text-4xl font-extrabold text-text-primary dark:text-dark-text-primary tracking-tight">NAVA Academy</h1>
                    <p className="mt-2 text-xl text-text-muted dark:text-dark-text-muted">Powering the Future of Mobility</p>
                </div>
                ...
                <div className="text-center mb-12">
                    <h3 className="text-3xl font-bold text-text-primary dark:text-dark-text-primary mb-8">Leadership Team</h3>
                ...
                <div>
                    <h3 className="text-3xl font-bold text-text-primary dark:text-dark-text-primary text-center mb-8">Core Programs</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="p-6 bg-slate-50 dark:bg-dark-panel-hover border border-slate-200 dark:border-dark-border rounded-lg">
                            <h5 className="font-bold text-xl text-text-primary dark:text-dark-text-primary">EV Industrial Technician Diploma</h5>
                            <p className="text-base text-text-secondary dark:text-dark-text-secondary mt-1">Focuses on automated manufacturing and production, covering robotics, PLC systems, and smart manufacturing principles.</p>
                        </div>
                        <div className="p-6 bg-slate-50 dark:bg-dark-panel-hover border border-slate-200 dark:border-dark-border rounded-lg">
                            <h5 className="font-bold text-xl text-text-primary dark:text-dark-text-primary">EV Service Technician Diploma</h5>
                            <p className="text-base text-text-secondary dark:text-dark-text-secondary mt-1">Prepares technicians to diagnose, service, and repair cutting-edge electric vehicles, focusing on high-voltage systems and advanced diagnostics.</p>
                        </div>
                    </div>
                </div>
