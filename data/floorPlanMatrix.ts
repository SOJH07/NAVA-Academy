...
export const FLOOR_PLANS: FloorMatrix[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      [{ code: "LAP-110", type: "Lab" }, { code: "L-115", type: "Facility" }],
      [{ code: "LAP-111", type: "Lab" }, { code: "L-116", type: "Facility" }],
      [{ code: "LAP 112 Computer Lab-1", type: "Lab" }, { code: "L-117", type: "Facility" }],
    ],
  },
  {
    name: "2nd (Classrooms)",
